    ...
    public function apply($model, RepositoryInterface $repository)
    {
        ...
        if (isset($orderBy) && !empty($orderBy)) {
            ...
            if(count($split) > 1) {
                 ...
                 * Custom:
                 *
                 * This will set the foreign key from joining table
                 *
                 */
                if (isset($sortTable) && !empty($sortTable)) {
                    $split = explode('.', $sortTable);
                ...
                $model = $model
                    ->leftJoin($sortTable, $keyName, '=', $sortTable.'.'.(isset($foreignKey) && !empty($foreignKey) ? $foreignKey : 'id'))
